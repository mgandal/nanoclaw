...
- 2026-04-21: Google/OAuth/security alerts (auth failures, token expiry, rclone-style grant notifications) route to OPS-claw (`tg:-1003829244894`), not CLAIRE. rclone OAuth grants are user-authorized and expected — don't alarm
