...
// save_skill tests moved to src/ipc/handlers/skills.test.ts (Batch 2G migration).

// crystallize_skill tests moved to src/ipc/handlers/skills.test.ts (Batch 2G migration).

// skill_invoked invocation logging tests moved to src/ipc/handlers/skills.test.ts (Batch 2G migration).
...
// save_skill result file tests moved to src/ipc/handlers/skills.test.ts (Batch 2G migration).

// save_skill missing skillContent tests moved to src/ipc/handlers/skills.test.ts (Batch 2G migration).
...
// skill_search tests moved to src/ipc/handlers/skills.test.ts (Batch 2G migration).
