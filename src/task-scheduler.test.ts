...
describe('task scheduler', () => {
  ...
  it('computeNextRun skips missed intervals without infinite loop', () => {
    // Task was due 10 intervals ago (missed). Interval must be above
    // MIN_INTERVAL_MS (30min) so the runtime safety net does not short-circuit
    // the skip-past loop under test here.
