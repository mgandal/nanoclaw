...
// Under Bun `import.meta.dir` is set; under some test environments it may be
// undefined, in which case fall back to process.cwd() (tests don't use
// PROJECT_ROOT for anything load-bearing).
